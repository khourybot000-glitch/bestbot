...
# --- CONFIGURATION ---
TOKEN = "8433565422:AAEEmu5zk6XtxW05amK2u2FOa0JP9Q9GRME"
            ...
            if now.second == 0 and now.minute != last_processed_minute:
                ...
                if len(prices) >= 1500:
                    ...
                    if direction:
                        ...
                        for token in session['tokens']:
                            ...
                            if acc:
                                ...
                                buy_params = {
                                    ...
                                    "currency": acc.get("currency", "USD"), "duration": 3, "duration_unit": "m",
                                    "symbol": "R_100"
                                }
                        ...
                        time.sleep(186) # مدة الانتظار المطلوبة لضمان استقرار النتيجة
