...
# --- Trading Bot Logic (FINAL BARRIER OFFSET VERSION) ---
def run_trading_job_for_user(session_data, check_only=False):
    ...
    try:
        ...
        if not check_only and not contract_id: 
            ...
            # 🚨 NOTOUCH CONFIGURATION - مع استخدام barrier_offset 🚨
            ...
            proposal_req = {
                ...
                "symbol": symbol, 
                "barrier_offset": offset_value,    # ⬅ المفتاح الصحيح
                "barrier_type": barrier_type       # ⬅ لتأكيد النوع
            }
        ...
        with stats_placeholder.container():
            ...
            if stats.get('contract_id'):
                st.warning(f"⚠ Trade Active: {stats.get('contract_id')}. Stats update after completion.")
                 ...
                 st.info("🕒 Waiting for next trade cycle (Seconds 0-4 UTC).")
