...
bot = telebot.TeleBot("8272483794:AAFxnW_AYxd3L6C1UI_DBYxJtUjXHGEOP1U")
...
@app.route('/')
def home():
    return "BOT ACTIVE - TOKEN REPLACED - TREND MODE"
    ...
    try:
        ...
        if len(prices) >= 5:
            ...
            if abs(diff) >= 0.8:
                ...
                # صاعد يدخل CALL-1.0 | هابط يدخل PUT+1.0
                ...
                if prop:
                    ...
                    if "buy" in buy_res:
                        ...
                        bot.send_message(state_proxy["chat_id"], f"🚀 **{c_t} Started**\nBarrier: {br}\nStake: {state_proxy['current_stake']:.2f}")
